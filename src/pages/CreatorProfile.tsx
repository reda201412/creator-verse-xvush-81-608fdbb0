...
const mockCreators = {
  ...
  'c1': {
    ...
    bio: 'Photographe et cinéaste passionné par la capture de moments authentiques. Explorer la vie à travers mon objectif est ma plus grande passion.',
    coverImage: 'https://images.unsplash.com/photo-1500051638674-ff996a0ec29e?q=80&w=2874',
    profession: 'Photographe & Cinéaste',
...
// DNA characteristics for different creators
const creatorAttributes = {
  'laura_creative': {
    skills: ['Design Visuel', 'Vidéographie', 'Narration', 'Édition', 'Direction Artistique', 'Motion Design'],
    style: ['Minimaliste', 'Contemporain', 'Expressif', 'Narratif', 'Immersif', 'Expérimental'],
    achievements: ['Prix de Design 2023', 'Exposition Virtuelle', '10K Abonnés', 'Collaboration Majeure', 'Article de Presse']
  },
  'c1': {
    skills: ['Photographie', 'Cadrage', 'Post-production', 'Montage vidéo', 'Éclairage', 'Storytelling visuel'],
    style: ['Documentaire', 'Urbain', 'Minimaliste', 'Atmosphérique', 'Haute définition', 'Contrasté'],
    achievements: ['Exposition photo 2023', 'Publication magazine', '5K Abonnés', 'Reportage primé', 'Collection limitée']
  }
};

// Journey milestones for different creators
  ...
  'c1': [
    {
      ...
      description: 'Début de mon parcours créatif sur la plateforme.',
      metricBefore: 0,
      metricAfter: 35,
      metricLabel: 'Abonnés'
    },
    {
      id: 'milestone-2',
      date: 'Septembre 2022',
      title: 'Première série photo',
      description: 'Publication de ma première série photo qui a capté l\'attention de la communauté.',
      metricBefore: 35,
      metricAfter: 280,
      metricLabel: 'Abonnés'
    },
    {
      ...
      description: 'Lancement de mon premier workshop en ligne exclusif aux abonnés.',
      metricBefore: 450,
      metricAfter: 980,
      metricLabel: 'Abonnés'
    },
    {
      ...
      date: 'Mai 2023',
      title: 'Badge Silver',
      description: 'Obtention du badge Silver grâce à la qualité et régularité de mon contenu.',
      metricBefore: 1200,
      metricAfter: 1800,
      metricLabel: 'Abonnés'
    }
  ...
  'c1': [
    {
      id: 1,
      userId: 'user124',
      title: 'Les secrets de la photo urbaine',
    ...
    },
    {
      id: 2,
      userId: 'user124',
      title: 'Techniques d\'éclairage pour portraits',
      thumbnailUrl: 'https://images.unsplash.com/photo-1554941829-202a0b2403b8?w=800&h=450&fit=crop',
      type: 'standard',
      viewCount: 2890,
      likeCount: 540,
      commentCount: 37
    },
    {
      id: 3,
      userId: 'user124',
      title: 'Voyage photographique à travers Paris',
      thumbnailUrl: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800&h=450&fit=crop',
      type: 'standard',
      viewCount: 3250,
      likeCount: 590,
      commentCount: 62
    },
    {
      id: 4,
      userId: 'user124',
      title: 'Workflow de post-production professionnelle',
      thumbnailUrl: 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=800&h=450&fit=crop',
      type: 'premium',
      viewCount: 1980,
      likeCount: 320,
      commentCount: 41,
...
const CreatorProfile = () => {
  ...
  // Get creator data based on username
  const creatorData = mockCreators[username as keyof typeof mockCreators] || mockCreators['laura_creative'];
  const creatorSkills = creatorAttributes[username as keyof typeof creatorAttributes]?.skills || creatorAttributes['laura_creative'].skills;
  const creatorStyle = creatorAttributes[username as keyof typeof creatorAttributes]?.style || creatorAttributes['laura_creative'].style;
  const creatorAchievements = creatorAttributes[username as keyof typeof creatorAttributes]?.achievements || creatorAttributes['laura_creative'].achievements;
  const journeyMilestones = creatorJourneys[username as keyof typeof creatorJourneys] || creatorJourneys['laura_creative'];
  const videos = creatorVideos[username as keyof typeof creatorVideos] || creatorVideos['laura_creative'];
